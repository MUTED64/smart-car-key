<template>
  <ion-modal :is-open="isOpen" css-class="modal3" @onDidDismiss="handleDidDismiss(true)">
    <form>
      <ion-label class="title" color="medium"><h1>Fill in the information about the user you want to share key with.</h1></ion-label>
      <ion-card>
        <ion-item lines="none">
          <ion-label color="medium" position="floating">User Id</ion-label>
          <ion-input required type="text" v-model="user"></ion-input>
        </ion-item>
      </ion-card>
      <ion-card>
        <ion-item lines="none">
